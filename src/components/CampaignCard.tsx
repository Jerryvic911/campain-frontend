...
export const CampaignCard: React.FC<CampaignCardProps> = ({ campaignAddress }) => {
    ...
    return (
            <div className="mt-20 flex flex-col justify-between w-[303px] h-[242px] pl-10 p-6 bg-black border border-slate-200 rounded-lg shadow">
                <div>
                ...
                >
                    ...
                    <p className="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        View Campaign
